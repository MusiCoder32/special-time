### 注意:国内无法直接使用chat,体验小程序中使用了aws服务器。源码只有chatgpt的使用方法，无法使你直接访问chatgpt,，服务器问题自行解决，不提供方案，可提供一周时间的chatgpt接口调用key、指导如何使用自己邮箱注册chatgpt、提供海外手机号验证码、指导如何使用自己账号的API_KEY
