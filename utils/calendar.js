 ...
 * @eg:var MonthDay = calendar.lunarDays(1987,9) ;//MonthDay=29
 */

export function lunarDays(y, m) {
    if (m > 12 || m < 1) {
        return -1
    } // 月份参数从1至12，参数错误返回-1
...
export function solar2lunar(y, m, d) {
    ...
    for (i = 1; i < 13 && offset > 0; i++) {
        ...
        if (leap > 0 && i === leap + 1 && isLeap === false) {
            ...
            temp = lunarDays(year, i) // 计算农历普通月天数
        }
