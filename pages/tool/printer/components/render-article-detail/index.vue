    ...
    <view class="content">
        <template v-for="op in renderDelta">
            ...
            <render-image
                ...
                :style="op.style"
            ></render-image>
            <render-list v-else-if="op.type === 'list'" :data="op.data" :style="op.style"></render-list>
            <view v-else-if="op.type === 'divider'" class="divider"></view>
            <render-video v-else-if="op.type === 'mediaVideo'" :data="op.data"></render-video>
