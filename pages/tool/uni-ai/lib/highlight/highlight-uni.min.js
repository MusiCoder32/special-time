    ...
    ;((e) => {
        ...
        ((e) => {
            if (Array.isArray(e.begin)) {
                ...
                if ('object' != typeof e.beginScope || null === e.beginScope) throw (F('beginScope must be object'), P)
                K(e, e.begin, {
                    key: 'beginScope',
                }),
                    (e.begin = f(e.begin, {
        ...
        ((e) => {
            if (Array.isArray(e.end)) {
                ...
                if ('object' != typeof e.endScope || null === e.endScope) throw (F('endScope must be object'), P)
                K(e, e.end, {
                    key: 'endScope',
                }),
                    (e.end = f(e.end, {
    ...
    function f(e, n, i, r) {
        ...
        function c() {
            ...
            for (; n; ) {
                ...
                if (r) {
                    const [e, a] = r
                    if ((M.addText(t), (t = ''), (l[i] = (l[i] || 0) + 1), l[i] <= 7 && (A += a), e.startsWith('_')))
                        t += n[0]
                    else {
    ...
    function y(e) {
        ...
        const t = ((e) => {
            ...
            if (t) {
                const n = v(t[1])
                return (
                    n || (U(o.replace('{}', t[1])), U('Falling back to no-highlight mode for this block.', e)),
                    n ? t[1] : 'no-highlight'
                )
            }
        ...
        Object.assign(n, {
            ...
            registerLanguage: (e, t) => {
                ...
                try {
                    ...
                    if ((F("Language definition for '{}' could not be registered.".replace('{}', e)), !s)) throw n
                    F(n), (i = l)
                }
                i.name || (i.name = e),
                    (a[e] = i),
