...
function i(e, r, t) {
    ...
    for (
        ...
        if (((a = e.charCodeAt(n)), t && 37 === a && n + 2 < s && /^[0-9a-f]{2}$/i.test(e.slice(n + 1, n + 3))))
            (u += e.slice(n, n + 3)), (n += 2)
        else if (a < 128) u += l[a]
        ...
        e.replace(/(%[a-f0-9]{2})+/gi, function (e) {
            ...
            for (r = 0, n = e.length; r < n; r += 3)
                (s = parseInt(e.slice(r + 1, r + 3), 16)) < 128
                    ...
                    ? ((l += (c = ((s << 6) & 1984) | (63 & o)) < 128 ? '��' : String.fromCharCode(c)), (r += 3))
                    : 224 == (240 & s) &&
                      r + 6 < n &&
                      ...
                      128 == (192 & o) && 128 == (192 & i))
                    ? ((l +=
                          (c = ((s << 12) & 61440) | ((o << 6) & 4032) | (63 & i)) < 2048 || (c >= 55296 && c <= 57343)
                              ? '���'
                    ...
                    ? ((c = ((s << 18) & 1835008) | ((o << 12) & 258048) | ((i << 6) & 4032) | (63 & a)) < 65536 ||
                      c > 1114111
                          ? (l += '����')
        ...
        return i.hidden
            ...
            : (i.block && -1 !== i.nesting && r && e[r - 1].hidden && (s += '\n'),
              ...
              i.block &&
                  ...
                  1 === i.nesting &&
                      r + 1 < e.length &&
                      ('inline' === (n = e[r + 1]).type || n.hidden || (-1 === n.nesting && n.tag === i.tag)) &&
                      (o = !1)),
              (s += o ? '>\n' : '>'))
    }),
    ...
    le = [
        ...
        [
            ...
            function (e) {
                ...
                if (e.md.options.typographer)
                    for (r = e.tokens.length - 1; r >= 0; r--)
                        'inline' === e.tokens[r].type && X.test(e.tokens[r].content) && te(e.tokens[r].children, e)
            },
        ],
        [
            'text_join',
...
function de(e) {
    ...
    for (r = e.charCodeAt(n); n < s; )
        124 === r &&
            (o ? ((a += e.substring(i, n - 1)), (i = n)) : (t.push(a + e.substring(i, n)), (a = ''), (i = n + 1))),
            (o = 92 === r),
            n++,
            (r = e.charCodeAt(n))
...
function ke(e, r) {
    ...
    return (
        ...
        (s = e.eMarks[r]),
        (42 !== (t = e.src.charCodeAt(n++)) && 45 !== t && 43 !== t) || (n < s && ((o = e.src.charCodeAt(n)), !_e(o)))
            ? -1
            : n
    )
}
    ...
    Re = [
            ...
            function (e, r, t, n) {
                ...
                for (
                    d = [e.bsCount[r]],
                        ...
                        p = r + 1;
                    p < t && ((A = e.sCount[p] < e.blkIndent), !((D = e.bMarks[p] + e.tShift[p]) >= (w = e.eMarks[p])));
                    p++
                )
        ...
        [
            ...
            function (e, r, t, n) {
                ...
                if (
                    (n && 'paragraph' === e.parentType && e.sCount[r] >= e.blkIndent && (z = !0), (w = be(e, r)) >= 0)
                ) {
                    if (((u = !0), (q = e.bMarks[r] + e.tShift[r]), (g = Number(e.src.slice(q, w - 1))), z && 1 !== g))
                        return !1
                } else {
                ...
                return (
                    ((L = u ? e.push('ordered_list_close', 'ol', -1) : e.push('bullet_list_close', 'ul', -1)).markup =
...
function Be() {
    this.ruler = new Me()
    for (var e = 0; e < Re.length; e++) this.ruler.push(Re[e][0], Re[e][1], { alt: (Re[e][2] || []).slice() })
}
...
for (
    var Pe = /(?:^|[^a-z0-9.+-])([a-z][a-z0-9.+-]*)$/i, je = r.isSpace, Ue = r.isSpace, Ve = [], Ze = 0;
    Ze < 256;
    Ze++
)
    Ve.push(0)
    ...
    for (t = r.length - 1; t >= 0; t--)
        (95 !== (n = r[t]).marker && 42 !== n.marker) ||
            (-1 !== n.end &&
                ...
                (o.markup = a ? i + i : i),
                (o.content = ''),
                a && ((e.tokens[r[t - 1].token].content = ''), (e.tokens[r[n.end + 1].token].content = ''), t--)))
}
    ...
    gr = [
        ...
        [
            ...
            function (e, r) {
                ...
                if (((c = (s = e.src.slice(t, u)).length), e.backticksScanned && (e.backticks[c] || 0) <= t))
                ...
                if (m) {
                    ...
                    if (
                        (a < f && 91 === e.src.charCodeAt(a)
                            ? ((d = a + 1),
                              (a = e.md.helpers.parseLinkLabel(e, a)) >= 0 ? (s = e.src.slice(d, a++)) : (a = o + 1))
                            : (a = o + 1),
                        s || (s = e.src.slice(i, o)),
                ...
                if ((c = i + 1) < _ && 40 === e.src.charCodeAt(c)) {
                    ...
                    if (
                        (c < _ && 91 === e.src.charCodeAt(c)
                            ? ((d = c + 1),
                              (c = e.md.helpers.parseLinkLabel(e, c)) >= 0 ? (o = e.src.slice(d, c++)) : (c = i + 1))
                            : (c = i + 1),
                        o || (o = e.src.slice(a, i)),
            ...
            function (e, r) {
                ...
                if (35 === e.src.charCodeAt(o + 1)) {
                    if ((n = e.src.slice(o).match(ir)))
                        return (
                            r ||
                                ((t = 'x' === n[1][0].toLowerCase() ? parseInt(n[1].slice(1), 16) : parseInt(n[1], 10)),
...
;(kr.prototype.skipToken = function (e) {
    ...
    (kr.prototype.tokenize = function (e) {
        for (
            var r, t, n = this.ruler.getRules(''), s = n.length, o = e.posMax, i = e.md.options.maxNesting;
            e.pos < o;
...
function Er(e) {
    var r = (e.re = (function (e) {
            ...
            return (
                ...
                (r.tpl_email_fuzzy =
                    '(^|[><｜]|"|\\(|' + r.src_ZCc + ')(' + r.src_email_name + '@' + r.tpl_host_fuzzy_strict + ')'),
                (r.tpl_link_fuzzy =
                    '(^|(?![.:/\\-_@])(?:[$+<=>^`|｜]|' +
                    r.src_ZPCc +
                    '))((?![$+<=>^`|｜])' +
    ...
    for (s = t > 0 ? t + 1 : 0; s < f; ) {
        for (
            ...
            s >= f && Or('invalid-input'),
                ((c = (p = e.charCodeAt(s++)) - 48 < 10 ? p - 22 : p - 65 < 26 ? p - 65 : p - 97 < 26 ? p - 97 : 36) >=
                    36 ||
                    c > Br((zr - d) / i)) &&
                    Or('overflow'),
                (d += c * i),
